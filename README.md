...
| SFTP (browse books + progress sync, SSH + TOFU host keys, password or key auth) | ✅ |
...
- 🌐 **Network follow-ups** — SMB shares and SFTP key auth shipped (ADR-006/008/009/010); native Drive/OneDrive API sync remains open (needs owner-registered OAuth client IDs)
